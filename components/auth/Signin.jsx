...
export default function Signin() {
  ...
  return (
    <div className={`auth-container ${theme}`} style={styles.page}>
      ...
      <div style={styles.centerContainer}>
        ...
        >
          ...
          >
            Sign in to your EduTask account
          </p>

          {/* Email field */}
          <div style={styles.inputGroup} className="form-group">
            <label
              htmlFor="email"
              style={{
                ...styles.label,
          ...
          <div style={styles.inputGroup} className="form-group">
            ...
            <input
              ...
              required
            />
            <div className="form-text text-right">
